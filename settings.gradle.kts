...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("csv", "de.siegmar:fastcsv:4.3.0")
            library("oshi", "com.github.oshi:oshi-core:7.2.1")
            ...
            library("exposed-core", "org.jetbrains.exposed:exposed-core:1.3.0")
            library("exposed-jdbc", "org.jetbrains.exposed:exposed-jdbc:1.3.0")
