...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("jackson", "com.fasterxml.jackson.core:jackson-databind:2.22.0")
            ...
            library("xml", "com.fasterxml.jackson.dataformat:jackson-dataformat-xml:2.22.0")
            library("exposed-core", "org.jetbrains.exposed:exposed-core:1.3.1")
            library("exposed-jdbc", "org.jetbrains.exposed:exposed-jdbc:1.3.1")
            library("sqlite", "org.xerial:sqlite-jdbc:3.53.2.0")
            library("logback", "ch.qos.logback:logback-classic:1.5.37")
            library("kotest-assertions-core", "io.kotest:kotest-assertions-core:6.2.1")
            library("kotest-runner-junit5", "io.kotest:kotest-runner-junit5:6.2.1")
