...
object MapperFactory {
    ...
    fun from(console: Console, data: RomData): Mapper {
        return when (val id = data.info.mapperId) {
            ...
            167 -> Subor166(console)
            168 -> Racermate(console)
            170 -> Mapper170(console)
            171 -> Kaiser7058(console)
            ...
            201 -> NovelDiamond(console)
            202 -> Mapper202(console)
            ...
            209 -> JyCompany(console)
            210 -> Namco163(console)
            211 -> JyCompany(console)
            212 -> Mapper212(console)
            213 -> Mapper213(console)
            214 -> Mapper214(console)
            215 -> if (data.info.subMapperId == 1) Unl8237A(console) else Mapper215(console)
            216 -> Mapper216(console)
            217 -> Mapper217(console)
            218 -> MagicFloor218(console)
            219 -> Mapper219(console)
            220 -> Kaiser7057(console)
            221 -> Mapper221(console)
            ...
            333 -> Bmc8in1(console)
            334 -> Mapper334(console)
            335 -> BmcCtc09(console)
            ...
            487 -> Mapper487(console)
            513 -> Sachen9602(console)
            518 -> Dance2000(console)
            519 -> Eh8813A(console)
            521 -> DreamTech01(console)
            522 -> Lh10(console)
            529 -> T230(console)
            530 -> Ax5705(console)
            ...
            UnifBoard.UNL_255_IN_1.id -> Unl255in1(console)
            UnifBoard.UNL_8237A.id -> Unl8237A(console)
