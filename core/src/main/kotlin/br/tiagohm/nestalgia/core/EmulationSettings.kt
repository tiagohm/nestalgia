...
class EmulationSettings : Snapshotable {
    ...
    companion object {
        ...
        val DEFAULT_PALETTE = uintArrayOf(
        ...
        val UNSATURATED_PALETTE = uintArrayOf(
        ...
        val NESTOPIA_PALETTE = uintArrayOf(
        ...
        val COMPOSITE_DIRECT_PALETTE = uintArrayOf(
        ...
        val NES_CLASSIC_PALETTE = uintArrayOf(
        ...
        val ORIGINAL_HARDWARE_PALETTE = uintArrayOf(
        ...
        val PVM_STYLE_PALETTE = uintArrayOf(
        ...
        val SONY_CXA_2025_PALETTE = uintArrayOf(
        ...
        val WAVEBEAM_PALETTE = uintArrayOf(
